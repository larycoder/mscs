...
model Modelutils9pedGeneration
...
//		}
		...
		save pedestrian_path type: shp to: "../results/pedestrian paths.shp";
		save open_area type: shp to: "../results/open area.shp";
		save pedestrian_path collect each.free_space type: shp to: "../results/free spaces.shp";
	}
}
